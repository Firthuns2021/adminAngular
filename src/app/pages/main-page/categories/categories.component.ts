...
=============================================*/
  newCategory(): any{
     // el la siguiente función lo que hago es abrir el siguiente diálogo
    // utilizando el componente 'new-categories.html'
  ...
  changeState(e: any): any {
    ...
    if ( e.target.checked){
      ...
      this.categoriesService.patchData(e.target.id.split('_')[1], data).subscribe(
  ...
  // deleteCategory(id: string, name: string, image: string): any{
  //
